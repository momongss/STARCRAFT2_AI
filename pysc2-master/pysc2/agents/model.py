...
class DQN:
    ...
    def build_network(self, width = 10, L_rate = 1e-1):
        ...
        self.W1 = tf.Variable(tf.random_uniform([self.input_size, width], 0, 0.01))
        self.W2 = tf.Variable(tf.random_uniform([width, self.output_size], 0, 0.01))
        ...
        # self.train = tf.compat.v1.train.GradientDescentOptimizer(learning_rate=L_rate).minimize(self.loss)
